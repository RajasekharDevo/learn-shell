...
# Case condition
 # This can do only string comparisons, hence it is not a much preferred option.
...
#9. Quotes
 # Why Quotes ?
  # If there is any special character in input to the common then we use quotes .
